...
(function (global, factory) {
    ...
    var vueDragging = function (Vue, options) {
        // 判断vue 版本 使用对应语法
        var isPreVue = Vue.version.split('.')[0];
        // console.log("vue版本", isPreVue)
        ...
        function addDragItem(el, binding, vnode) {
            ...
            var drag_key = isPreVue === '1' ? binding.value.key : vnode.key;
        ...
        if (isPreVue === '3') {
            Vue.config.globalProperties.$dragging = $dragging;
        } else {
